...
parser.add_argument('-d'  ,'--directory'  ,default='./ae/models' ,metavar='{...}'    ,help='directory path containing the models')
parser.add_argument('-p'  ,'--path'       ,default='./ae/models/ae0_80.pt'       , help='Specify the model path')
